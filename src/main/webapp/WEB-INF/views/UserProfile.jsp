				...
				<body>
				    ...
				    <div class="container">
				        <div class="profile-card text-center">
				            ...
				            <button class="btn btn-success" id="order" >See Orders</button>
...
$(document).ready(function() {
    <% String tokenVal = jwtToken != null ? jwtToken.getValue() : ""; %>
    const jwtToken = "<%= tokenVal %>";
    ...
    window.onpopstate = function () {
        window.location.href = `${apiBase}/`; // redirect to home
    };
    ...
    $('#changePasswordForm').submit(function(e) {
        ...
        $.ajax({
            ...
            error: function() { 
                alert("Failed to change password. Please check current password."); 
            }
        });
    });
    ...
    $('#order').click(function(){
        ...
        $.ajax({
            url: "http://localhost:8080/ecomm.capstone/app/buyer/orders",
            type: "GET",
            headers: {
            ...
            error: function(xhr) {
                console.error("Orders load failed:", xhr.status, xhr.responseText);
