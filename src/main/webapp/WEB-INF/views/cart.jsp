                        ...
                        <c:forEach var="item" items="${cart.items}" varStatus="loop">
                            <tr>
                                ...
                                <td>
                                    <form method="post" action="updateQuantity.jsp" class="d-flex">
                                        <input type="hidden" name="id" value="${item.id}">
                                        <input type="number" name="quantity" value="${item.quantity}" min="1" class="form-control form-control-sm quantity">
                                    </form>
                                </td>
...
$(document).ready(function() {
    ...
    $(document).on("input blur change", ".quantity", function() {
        let val = parseInt($(this).val());
        if (isNaN(val) || val < 1) {
            alert("❌ Quantity cannot be less than 1 and price cannot be negative.");
            $(this).val(1);
        }
        updateCartSummary();
    });
