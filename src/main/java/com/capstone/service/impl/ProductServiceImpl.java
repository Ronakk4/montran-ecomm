...
public class ProductServiceImpl implements ProductService {
	...
	public void deleteProduct(long id) {
		...
		// fetch product from Products and add to history before deleting
		Product productToDelete = productDao.getProduct(id);
		
		ProductInsertDTO dto = new ProductInsertDTO(productToDelete.getProdName(), productToDelete.getProdDescription(),
				productToDelete.getPrice(), productToDelete.getStockQuantity(), productToDelete.getCategory(),
				productToDelete.getCreatedAt(), productToDelete.getUpdatedAt(), productToDelete.getSeller().getId(),
				productToDelete.getImages());
		
		productHistoryService.addProductHistory(dto);
		
		// finally delete after saving in history
