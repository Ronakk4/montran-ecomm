...
public class SellerController {
    ...
    // Change the parameter to ProductInsertDTO for validation
    @PostMapping("/products")
    public String addProduct(@Valid @RequestBody ProductInsertDTO productDTO) {
        productService.saveProduct(productDTO);  // Pass DTO to service
        return "Product added successfully";
    }

    @PutMapping("/products/{id}")
    public String updateProduct(@PathVariable long id, @Valid @RequestBody ProductInsertDTO productDTO) {
        productService.saveProduct(productDTO);  // Pass DTO to service
        return "Product updated successfully";
    }
